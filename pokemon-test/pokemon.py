...
def delay_print(s):
    ...
    #Create a class ClassName(object):
    class Pokemon:
                ...
                if self.types ==k:
                    ...
                    if Pokemon2.types == version[(i+2)%3]:
                        ...
                        while(self.bars > 0) and (Pokemon2.bars > 0):
                            ...
                            if _name_ == '_main_':
                                #Create POKEMON
                                Charizard = Pokemon ('Charizard','Fire', ['Flamethrower', 'Fly', ' Blast Burn', 'Fire Punch'], {'ATTACK':12 , 'DFEENSE':8})
                                Blastoise = Pokemon ('Blastoise', ' Water', [ 'Water Gun', 'Bubblebeam', 'Hydro Pump', 'Surf'],{'ATTACK':10, 'DEFFENSE':10})
                                ...
                                Squirtle = Pokemon('Squirtle','Water',['Bubblebeam', ' Tackle','Headbutt', 'Surf'], {'ATTACK':3 , 'DEFFENSE:3'})
                                Bulbasaur = Pokemon ('Bulbasaur', ' Grass', ['Vine Wip', ' Razor Leaf', ' Tackle', 'Leech Seed'], {'ATTACK':2, 'DEFENSE':5})

                                Charmeleon = Pokemon ('Charmeleon','Fire', ['Ember','Scratch', 'Flamethrower', 'Fire Punch'], {'ATTACK':6, 'DEFENSE':5 })
                                Wartorle = Pokemon('Wartorle','Water', ['Bubblebeam', 'Water Gun', 'Headbutt', 'Surf'], {'ATTACK':4, 'DEFENSE':6})
